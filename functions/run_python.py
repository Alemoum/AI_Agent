...
schema_run_python_file = types.FunctionDeclaration(
    ...
    description="Executes a Python file and returns its output. The file must exist in the working directory.",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "file_path": types.Schema(
                type=types.Type.STRING,
                description="The name of the Python file to be executed.",
            ),
        },
        required=["file_path"],
    ),
